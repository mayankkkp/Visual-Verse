...
function Login() {
  ...
  useEffect(() => {
    ...
    axios.get("https://visual-verse-1.onrender.com/login", { withCredentials: true })
      .then(response => {
  ...
  //   try {
  //     const response = await axios.get("http://localhost:5000/api/auth/google"); // Backend endpoint for Google login
